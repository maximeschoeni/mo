            ...
            slideshow.children = [
              {
                ...
                children: this.images.map((image, index) => {
                  ...
                  return {
                    ...
                    update: slide => {
                      slide.element.classList.toggle("active", this.currentSlide && this.currentSlide.id === image.id || false);
                      slide.children = [
                        {
                          class: "media",
                          children: [
                            {
                              ...
                              child: {
                                ...
                                update: img => {
                                  img.element.src = `images/${mediaId}.jpeg`;
                                ...
                                children: [
                                  {
                                    ...
                                    children: [
                                      {
                                        class: "images",
                                        children: image.noinvs.slice(1).map(noinv => {
                                          return {
                                            tag: "img",
                                            update: img => {
                                              img.element.src = `images/${noinv}.jpeg`;
                                      ...
                                      },
                                      {
                                        ...
                                        children: [
                                          ...
                                          },
                                          {
                                            class: "text",
                                            update: content => {
                                              content.element.innerHTML = image.note;
                                            }
                                          }
                                        ]
                                      },
